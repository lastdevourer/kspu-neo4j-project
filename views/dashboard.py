...
def render() -> None:
    ...
    render_header(
        ...
        subtitle="Огляд структури університету, викладачів, публікацій і співавторства в єдиному інформаційному середовищі.",
    )
    ...
    if counts["publications"] == 0:
        st.info(
            "Структура вже заведена. Для наповнення бази відкрийте сторінку `Структура`: основні публікаційні дані можна "
            "завантажити з відкритих сторінок ХДУ, а зовнішні сервіси використовувати для додаткового пошуку відомостей."
        )
    else:
