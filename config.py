...
def get_connection_help_text() -> str:
    return (
        ...
        "`ADMIN_PASSWORD` (Ð¿Ð°Ñ€Ð¾Ð»ÑŒ Ð´Ð»Ñ Ñ€Ð¾Ð·Ð±Ð»Ð¾ÐºÑƒÐ²Ð°Ð½Ð½Ñ Ñ€ÐµÐ¶Ð¸Ð¼Ñƒ ÐºÐµÑ€ÑƒÐ²Ð°Ð½Ð½Ñ Ð²ÑÐµÑ€ÐµÐ´Ð¸Ð½Ñ– Ñ‚Ñ–Ñ”Ñ— Ð¶ app)\n"
        "`DEFAULT_UI_THEME` (`dark` Ð°Ð±Ð¾ `light`; ÑÐºÑ‰Ð¾ Ð½Ðµ Ð·Ð°Ð´Ð°Ð½Ð¾, Ð²Ð¸ÐºÐ¾Ñ€Ð¸ÑÑ‚Ð¾Ð²ÑƒÑ”Ñ‚ÑŒÑÑ Ñ‚ÐµÐ¼Ð½Ð° Ñ‚ÐµÐ¼Ð°)\n"
        "`ADMIN_MODE` (`true` Ð»Ð¸ÑˆÐµ ÑÐºÑ‰Ð¾ Ñ…Ð¾Ñ‡ÐµÑ‚Ðµ Ð¿Ñ€Ð¸Ð¼ÑƒÑÐ¾Ð²Ð¾ Ñ‚Ñ€Ð¸Ð¼Ð°Ñ‚Ð¸ Ð°Ð´Ð¼Ñ–Ð½Ñ€ÐµÐ¶Ð¸Ð¼ ÑƒÐ²Ñ–Ð¼ÐºÐ½ÐµÐ½Ð¸Ð¼ Ð´Ð»Ñ Ð²ÑÑ–Ñ… Ð²Ñ–Ð´Ð²Ñ–Ð´ÑƒÐ²Ð°Ñ‡Ñ–Ð²)"
    )
